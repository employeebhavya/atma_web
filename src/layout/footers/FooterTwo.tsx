...
const footer_content: ContentType = {
  footer_about_text:
    "ATMA is as an organization formed to promote charitable work through their foundation (ATMA-CF) nationally and internationally.",
  gallery: [
    footerGallery_1,
    footerGallery_2,
    footerGallery_3,
  ...
  copyright_text: "Copyright 2024 ATMA USA. All Right Reserved.",
};
